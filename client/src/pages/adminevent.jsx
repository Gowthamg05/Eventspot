...
const AdminEventTable = () => {
  ...
  return (
  <div className="p-4">
    <h2 className="text-xl sm:text-2xl font-bold mb-4">Events Overview</h2>
    ...
    <div className="mt-6">
      <button
        ...
        className="bg-gray-500 hover:bg-gray-600 text-white font-semibold px-4 py-2 rounded-lg w-full sm:w-auto"
      >
        Back
      </button>
    </div>
