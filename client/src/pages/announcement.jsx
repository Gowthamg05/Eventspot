...
const AnnouncementDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 py-12 px-4 font-inter">
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-xl border border-blue-100">

        <div className="text-center mb-8">
          <h2 className="text-4xl font-extrabold text-indigo-700">📢 Create Announcement</h2>
          <p className="mt-2 text-gray-600">Send announcements to students, faculty, or everyone at once.</p>
        </div>
