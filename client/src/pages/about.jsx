...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-indigo-50 to-pink-50 py-12 px-6 font-inter text-gray-800">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">

        {/* About the Project */}
        <div className="bg-white shadow-lg rounded-xl p-8 border border-indigo-100">
          <h2 className="text-3xl font-bold text-indigo-700 mb-4 border-b-2 border-indigo-400 inline-block pb-1">
            About the Project
          </h2>
        ...
        <div className="bg-white shadow-lg rounded-xl p-8 border border-pink-100">
          <h2 className="text-3xl font-bold text-pink-700 mb-4 border-b-2 border-pink-400 inline-block pb-1">
            About the Developer
          </h2>
          ...
          <img
            src="/gowtham-1.jpg"
            alt="Gowtham"
            className="w-28 h-28 rounded-full object-cover mb-4 border-4 border-pink-300"
          />
          ...
          {/* Skills Section */}
          <h3 className="text-xl font-semibold text-pink-600 mb-2">Skills Used:</h3>
