...
const AdminProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-200 p-8 flex gap-6">
      {/* Profile Section */}
      <div className="w-1/4 bg-white rounded-3xl shadow-xl p-6 flex flex-col items-center hover:shadow-2xl transition">
        <img
          src={adminData.photo}
          alt="Profile"
        ...
        <p className="text-sm text-gray-500">{adminData.organizer}</p>
      ...
      {/* Dashboard Content */}
      <div className="w-3/4">
        <h1 className="text-3xl font-extrabold text-gray-800 text-center mb-8 tracking-wide">
          Admin Dashboard
        </h1>
